<template>
  <div class="rank">
    ...
    <div class="profit-box">
      <span class="profit-total">{{currentScoreText}}</span>
    </div>
...
export default {
  data() {
    return {
      loading: false,
      finished: false,
      iconIn: require("../../assets/img/profit-in.png"),
      iconOut: require("../../assets/img/profit-out.png"),
      currentScoreText: "",
      params: {
        direction: 0,
        pageIndex:1,
  ...
  methods: {
    ...
    getData() {
      this.loading = true;
      this.$http.post("customer/UserInfo/GetUserScoreLog", this.params).then(res => {
        this.loading = false;
        this.pullLoading = false;
        this.totalCount = res.data.Body.totalCount;
        this.currentScoreText = res.data.Body.currentScoreText;
